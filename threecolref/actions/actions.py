...
from threecolref.actions.menu_structure import menu_structure
from threecolref.config import KeyboardSettings, settings_events
...
bee_actions = ActionList([
    ...
    Action(
        id='export_item',
        text='Export This &Item...',
        shortcuts=['Ctrl+E'],
        callback='on_action_export_item',
        group='active_when_single_selection',
    ),
    Action(
        id='quit',
        text='&Quit',
    ...
    Action(
        ...
        callback='on_action_facing_problem',
    ),
    Action(
        id='show_scrollbars',
