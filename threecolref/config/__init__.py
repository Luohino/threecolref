...
from threecolref.config.controls import KeyboardSettings  # noqa F401
from threecolref.config.settings import (   # noqa F401
    BeeSettings,
    CommandlineArgs,
    settings_events,
)
from threecolref.logging import qt_message_handler
...
logging_conf = {
    ...
    'handlers': {
        ...
        'file': {
            'class': 'threecolref.logging.BeeRotatingFileHandler',
            'formatter': 'verbose',
