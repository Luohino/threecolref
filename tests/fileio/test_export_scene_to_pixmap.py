...
@patch('threecolref.widgets.SceneToPixmapExporterDialog.exec', return_value=True)
...
@patch('threecolref.widgets.SceneToPixmapExporterDialog.exec', return_value=False)
@patch('threecolref.widgets.SceneToPixmapExporterDialog.value')
...
@patch('threecolref.scene.BeeGraphicsScene.render')
