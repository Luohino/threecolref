...
from threecolref.actions.actions import Action
from threecolref.actions.menu_structure import MENU_SEPARATOR
from threecolref.utils import ActionList
...
@patch('threecolref.actions.mixin.menu_structure',
       [{'menu': 'Foo', 'items': ['foo']}])
@patch('threecolref.actions.mixin.actions',
       ActionList([Action(
           id='foo',
           text='&Foo',
           shortcuts=['Ctrl+F'],
...
@patch('threecolref.config.KeyboardSettings.get_list')
def test_create_actions(kb_mock, toggle_mock, trigger_mock, qapp):
    ...
    from threecolref.actions.mixin import actions
...
def test_create_actions_with_shortcut_from_settings(qapp, kbsettings):
    with patch('threecolref.actions.mixin.actions',
               ActionList([Action(
                   id='foo',
                   text='&Foo',
                   shortcuts=['Ctrl+F'],
...
@patch('threecolref.actions.mixin.actions', ActionList([]))
