...
from threecolref.config.controls import MouseWheelConfig
from threecolref.widgets.controls.mousewheel import (
    MouseWheelDelegate,
...
def test_mousewheel_editor_inits_modifiers_when_not_configured(view):
    action = MouseWheelConfig(
        ...
        modifiers=[],
        invertible=True)
    with patch('threecolref.config.controls.KeyboardSettings.MOUSEWHEEL_ACTIONS',
               ActionList([action])):
...
@patch('threecolref.widgets.controls.mousewheel.MouseWheelModifiersEditor.accept')
