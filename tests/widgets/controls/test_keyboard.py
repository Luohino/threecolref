...
from threecolref.widgets.controls.keyboard import (
...
def test_keyboard_shortcuts_editor_on_save_no_conflicts(view):
    ...
    with patch('threecolref.widgets.controls.keyboard.actions',
               ActionList([a1, a2])):
...
@patch('threecolref.widgets.controls.keyboard.actions',
       ActionList([
