...
from threecolref.logging import (
    BeeLogger,
...
@patch('threecolref.logging.BeeLogger.log')
...
@patch('threecolref.logging.qtlogger.info')
...
@patch('threecolref.logging.qtlogger.warning')
