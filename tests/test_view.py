...
from threecolref import commands, widgets
from threecolref.actions import actions
from threecolref.config import logfile_name
from threecolref.items import BeePixmapItem, BeeTextItem
from threecolref.view import BeeGraphicsView
...
@patch('threecolref.view.BeeGraphicsView.open_from_file')
def test_init_without_filenames(open_file_mock, qapp, commandline_args):
    ...
    assert view.parent.windowTitle() == 'threecolref'
    del view
...
@patch('threecolref.view.BeeGraphicsView.do_insert_images')
...
@patch('threecolref.widgets.welcome_overlay.WelcomeOverlay.hide')
def test_on_scene_changed_when_items(hide_mock, view):
    item = BeePixmapItem(QtGui.QImage())
    view.scene.addItem(item)
    view.scale(2, 2)
    with patch('threecolref.view.BeeGraphicsView.recalc_scene_rect') as r:
...
@patch('threecolref.widgets.welcome_overlay.WelcomeOverlay.show')
...
@patch('threecolref.view.BeeGraphicsView.fitInView')
...
@patch('threecolref.view.BeeGraphicsView.fitInView')
@patch('threecolref.view.BeeGraphicsView.centerOn')
...
@patch('threecolref.view.BeeGraphicsView.get_confirmation_unsaved_changes',
       return_value=False)
...
@patch('threecolref.view.BeeGraphicsView.clear_scene')
...
@patch('PyQt6.QtWidgets.QFileDialog.getSaveFileName')
@patch('threecolref.view.BeeGraphicsView.do_save')
...
@patch('PyQt6.QtWidgets.QFileDialog.getSaveFileName')
@patch('threecolref.fileio.sql.SQLiteIO.write_data')
...
@patch('threecolref.view.BeeGraphicsView.on_action_save_as')
...
@patch('threecolref.widgets.SceneToPixmapExporterDialog.exec')
@patch('threecolref.widgets.SceneToPixmapExporterDialog.value')
@patch('PyQt6.QtWidgets.QFileDialog.getSaveFileName')
...
@patch('threecolref.widgets.ExportImagesFileExistsDialog.exec',
       return_value=QtWidgets.QDialog.DialogCode.Accepted)
@patch('threecolref.widgets.ExportImagesFileExistsDialog.get_answer',
...
@patch('threecolref.view.BeeGraphicsView.get_confirmation_unsaved_changes',
       return_value=False)
@patch('threecolref.__main__.threecolrefApplication.quit')
...
@patch('threecolref.widgets.settings.SettingsDialog.show')
def test_on_action_settings(show_mock, view):
    view.on_action_settings()
    show_mock.assert_called_once()


@patch('threecolref.widgets.controls.ControlsDialog.show')
def test_on_action_keyboard_settings(show_mock, view):
    view.on_action_keyboard_settings()
    show_mock.assert_called_once()


@patch('threecolref.widgets.HelpDialog.show')
def test_on_action_help(show_mock, view):
    view.on_action_help()
    show_mock.assert_called_once()


@patch('threecolref.widgets.DebugLogDialog.show')
...
@patch('threecolref.scene.BeeGraphicsScene.clearSelection')
...
def test_on_action_copy_image(clipboard_mock, view, imgfilename3x3):
    ...
    assert mimedata.data('threecolref/items') == b'1'
    view.cancel_active_modes.assert_called_once_with()
...
@patch('threecolref.view.BeeGraphicsView.on_action_fit_scene')
@patch('threecolref.scene.BeeGraphicsScene.clearSelection')
...
def test_on_action_paste_internal(mimedata_mock, clear_mock, view):
    mimedata = QtCore.QMimeData()
    mimedata.setData('threecolref/items', QtCore.QByteArray.number(1))
...
@patch('PyQt6.QtGui.QClipboard.text')
@patch('PyQt6.QtGui.QClipboard.image')
@patch('threecolref.widgets.BeeNotification')
...
@patch('threecolref.view.BeeGraphicsView.on_action_copy')
...
@patch('threecolref.widgets.welcome_overlay.WelcomeOverlay.cursor')
...
@patch('threecolref.view.BeeGraphicsView.cursor')
...
@patch('threecolref.scene.BeeGraphicsScene.arrange')
...
@patch('threecolref.scene.BeeGraphicsScene.arrange_optimal')
def test_on_action_arrange_optimal(arrange_mock, view):
    view.on_action_arrange_optimal()
    arrange_mock.assert_called_once_with()


@patch('threecolref.scene.BeeGraphicsScene.arrange_square')
def test_on_action_arrange_square(arrange_mock, view):
    view.on_action_arrange_square()
    arrange_mock.assert_called_once_with()


@patch('threecolref.widgets.ChangeOpacityDialog.__init__',
       return_value=None)
...
def test_update_window_title_changes_no_filename(clear_mock, view):
    view.filename = None
    view.update_window_title()
    assert view.parent.windowTitle() == '[Untitled]* - threecolref'
...
def test_update_window_title_no_changes_filename(clear_mock, view):
    view.filename = 'test.bee'
    view.update_window_title()
    assert view.parent.windowTitle() == 'test.bee - threecolref'
...
@patch('threecolref.view.BeeGraphicsView.recalc_scene_rect')
@patch('threecolref.scene.BeeGraphicsScene.on_view_scale_change')
...
@patch('threecolref.view.BeeGraphicsView.reset_previous_transform')
@patch('threecolref.view.BeeGraphicsView.pan')
...
@patch('threecolref.view.BeeGraphicsView.zoom')
