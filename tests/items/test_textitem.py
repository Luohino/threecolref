...
from threecolref.items import BeeTextItem, item_registry
...
@patch('threecolref.items.BeeTextItem.boundingRect')
...
@patch('threecolref.items.BeeTextItem.setTextCursor')
...
@patch('threecolref.items.BeeTextItem.exit_edit_mode')
