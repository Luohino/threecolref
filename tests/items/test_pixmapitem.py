...
from threecolref.items import BeePixmapItem, item_registry
...
@patch('threecolref.selection.SelectableMixin.init_selectable')
...
@patch('threecolref.selection.SelectableMixin.hoverMoveEvent')
...
@patch('threecolref.selection.SelectableMixin.mousePressEvent')
...
@patch('threecolref.selection.SelectableMixin.mouseMoveEvent')
...
@patch('threecolref.selection.SelectableMixin.mouseReleaseEvent')
