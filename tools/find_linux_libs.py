...
# Create JSON with Linux libs needed for threecolref appimage
...
parser = argparse.ArgumentParser(
    description=('Create JSON with Linux libs needed for threecolref appimage'))
parser.add_argument(
    'pid',
    nargs=1,
    default=None,
    help='PID of running threecolref process')
parser.add_argument(
    '-l', '--loglevel',
    default='INFO',
...
if args.check_appimage:
    ...
    for lib in iter_lsofoutput(output):
        if 'mount_threecolref' not in lib:
